...
❌ ***Mani, can you please check I am taking the right genome reference in the liftover and annotation.***
...
> **ℹ️ Technical Note: Handling Structural Insertions (`MantaINS`)**
>
...
├── excel_and_other_files_provided   # Documents and other files shared by the team or Birmingham Bioinformatics
├── raw                              # Raw sequencing data
│   └── files                        # All TSO500 FASTQ (.ora) files
├── README.md                        # Documentation explaining how the data are organised
├── scripts                          # Scripts for data integrity checks and TSO500 sample grouping
